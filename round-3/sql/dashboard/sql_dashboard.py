        ...
        try:
            ...
            FROM `blog_db`.`t_anal_keywords`
              WHERE 1 = 1
                ...
                AND user_id = '{0}'
                '''
            query = query.format(_item['usr_id'])
    ...
    def getWebHistories(self,_item):
        ...
        try:
            ...
            SELECT 
                ...
                `t_analysis_datas`.`http_counts_in_contents`,
                `t_analysis_datas`.`image_hyperLink_cnt`,
                `t_analysis_datas`.`text_hyperLink_cnt`
        ...
        self.update(
            ...
            UPDATE 
             `keyword`= %s,
                ...
                `mobile_yn` = %s,
                `reg_dt` = %s,
                `http_counts_in_contents` = %s,
                `image_hyperLink_cnt` = %s,
                `text_hyperLink_cnt` = %s
            '''
            , [_item['keyword'],_item['post_url'],_item['blog_id'],_item['rank_no'],_item['total_words']
                ...
                ,_item['clipe_cnt'],_item['thumb_count'],_item['map_cnt'],_item['is_influencer'],_item['id']
                ,_item['mobile_yn'],time.strftime('%Y%m%d'),_item['http_counts_in_contents'],_item['image_hyperLink_cnt']
                ,_item['text_hyperLink_cnt']
